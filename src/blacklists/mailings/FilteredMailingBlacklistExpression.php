...
/**
 * The wrapper class for an expression of a Maileon mailing blacklist (Versandsperrliste in German) that has been filtered /
 * not been accepted by Maileon API. This class wraps the XML structure.
 *
