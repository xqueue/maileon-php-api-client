...
use XQueue\Maileon\API\MaileonAPIResult;
...
abstract class AbstractMaileonService
{
     ...
     *  if there was a connection problem or a server error occurred
     */
    public function put($resourcePath, $payload = "", $queryParameters = array(),
                        $mimeType = 'application/vnd.maileon.api+xml',
                        $deserializationType = null)
    {
        $curlSession = $this->prepareSession($resourcePath, $queryParameters, $mimeType);
     ...
     *  if there was a connection problem or a server error occurred
     */
    public function post($resourcePath, $payload = "", $queryParameters = array(),
                        $mimeType = 'application/vnd.maileon.api+xml',
                        $deserializationType = null,
                        $contentType = null,
                        $contentLength = null)
     ...
     *  if there was a connection problem or a server error occurred
     */
    public function delete($resourcePath, $queryParameters = array(),
                        $mimeType = 'application/vnd.maileon.api+xml',
                        $deserializationType = null)
    {
        $curlSession = $this->prepareSession($resourcePath, $queryParameters, $mimeType);
    ...
    private function prepareSession($resourcePath, $queryParameters, $mimeType, $contentType = null, $contentLength = null)
    {
