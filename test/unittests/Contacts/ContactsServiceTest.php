...
class ContactsServiceTest extends TestCase
{
    ...
    public function testGetContactByEmail()
    {
        ...
        $this->assertInstanceOf('de\xqueue\maileon\api\client\contacts\Contact', $contact);
    ...
    public function testGetContacts()
    {
        ...
        for ($pageIndex = 1; !$found && ($pageIndex - 1) * 100 < $numContacts; $pageIndex++) {
            ...
            $this->assertInstanceOf('de\xqueue\maileon\api\client\contacts\Contact', $contacts);
    ...
    public function testContactsWereSynchronized()
    {
        ...
        $contacts = $response->getResult();
        $this->assertInstanceOf('de\xqueue\maileon\api\client\contacts\Contacts', $contacts);
